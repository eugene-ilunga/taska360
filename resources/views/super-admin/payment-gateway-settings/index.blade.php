                ...
                <div class="s-b-n-header" id="tabs">
                    <nav class="tabs border-bottom-grey">
                        <ul class="nav -primary" id="nav-tab" role="tablist">
                            ...
                            @endif
                            <li>
                                <a class="nav-item nav-link f-15 freshpay" data-toggle="tab"
                                   href="{{ route('superadmin.settings.global-payment-gateway-settings.index') }}?tab=freshpay" role="tab"
                                   aria-controls="nav-freshpay" aria-selected="false">FreshPay
                                    <i
                                        class="fa fa-circle f-12 ml-1 {{ $credentials->freshpay_status == 'active' ? 'text-light-green' : 'text-red' }}"></i>
                                </a>
                            </li>
...
@push('scripts')
    ...
    <script>
        ...
        $("body").on("change", "#freshpay_status", function (event) {
            $('#freshpay_details').toggleClass('d-none');
        });
        ...
        $("body").on("click", ".generate-freshpay-key", function () {
        ...
        $("body").on("click", "#save_paypal_data, #save_stripe_data, #save_razorpay_data, #save_paystack_data, #save_flutterwave_data, #save_mollie_data, #save_payfast_data, #save_authorize_data, #save_square_data, #save_freshpay_data", function (event) {
            $.easyAjax({
