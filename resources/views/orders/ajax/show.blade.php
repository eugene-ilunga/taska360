...
<div class="card border-0 invoice">
    ...
    <div class="card-footer bg-white border-0 d-flex justify-content-start py-0 py-lg-4 py-md-4 mb-4 mb-lg-3 mb-md-3 ">
        ...
        <div class="d-flex">
                ...
                <div class="inv-action mr-3 mr-lg-3 mr-md-3 dropup">
                    ...
                    <ul class="dropdown-menu dropdown-menu-left" aria-labelledby="dropdownMenuButton" tabindex="0">
                        ...
                        @if ($credentials->freshpay_status == 'active')
                            <li>
                                <a class="dropdown-item f-14 text-dark" href="javascript:void(0);" data-order-id="{{ $order->id }}" id="freshpayModal">FreshPay</a>
                            </li>
                        @endif
            ...
            @if ($payment && $payment->gateway === 'FreshPay' && $payment->status === 'pending')
                <div class="alert alert-warning mt-3" id="freshpay-pending-banner"
                     data-poll-url="{{ route('freshpay.payment_status', [$payment->id, company()->hash]) }}">
