...
return array(
    ...
    'freshpay' => array(
        ...
        'email' => 'Email',
        'username' => 'Username',
        'callbackHelp' => 'Configure this callback URL and whitelist FreshPay IPs on your FreshPay account.',
        'phone' => 'Phone Number',
        'phonePlaceholder' => '0900000000 or 90000000',
        'operator' => 'Operator',
        'pendingHelp' => 'After sending the request, FreshPay will confirm the final result asynchronously.',
        'pendingState' => 'Request in progress. Please confirm the payment on your mobile wallet.',
        'requestSubmitted' => 'Request submitted successfully. Transaction in progress.',
        'invalidPhone' => 'Phone number must look like 0900000000 or 90000000.',
        'gatewayInactive' => 'FreshPay is not active for this company.',
        'missingCredentials' => 'FreshPay credentials are missing.',
    ),
    'mollie' => array(
        'client_name' => 'Name',
        'client_email' => 'Email',
