...
Route::get('/invoice-freshpay/freshpay-modal/', [HomeController::class, 'freshpayModal'])->name('front.freshpay_modal');
...
Route::post('freshpay-public/{id}/{hash}', [FreshPayController::class, 'paymentWithFreshPayPublic'])->name('freshpay_public');
Route::post('freshpay-webhook/{hash}', [FreshPayController::class, 'handleGatewayWebhook'])->name('freshpay.webhook');
Route::get('freshpay-webhook/{hash}', [FreshPayController::class, 'getWebhook'])->name('get_freshpay.webhook');
Route::get('freshpay-payment-status/{paymentId}/{hash}', [FreshPayController::class, 'paymentStatus'])->name('freshpay.payment_status');
Route::get('freshpay-wait/{paymentId}/{hash}', [FreshPayController::class, 'waitingPage'])->name('freshpay.waiting');
