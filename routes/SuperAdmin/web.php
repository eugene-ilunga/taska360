...
Route::group(['middleware' => ['auth', 'multi-company-select'], 'prefix' => 'account/settings'], function () {
    ...
    Route::post('billing/payment-freshpay', [BillingController::class, 'freshpayPayment'])->name('billing.freshpay');
    Route::get('billing/freshpay-status/{invoiceId}', [BillingController::class, 'freshpayStatus'])->name('billing.freshpay-status');
...
Route::post('save-freshpay-webhook/{id}', [BillingController::class, 'freshpayWebhook'])->name('billing.save_freshpay-webhook');
Route::get('save-freshpay-webhook/{id}', [BillingController::class, 'getWebhook'])->name('billing.get_freshpay-webhook');
